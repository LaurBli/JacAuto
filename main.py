...
class MainMenuScreen(GridLayout, Screen):
    def __init__(self, **kwargs):
        ...
        btn = Button(text='NITRO', font_size=120, background_color=(255, 0, 0))
        btn.bind(on_press=self.goto_calculatorNitro)
        self.add_widget(btn)
        btn = Button(text='Ambasade', font_size=120, background_color=(0, 0, 1, 1))
        btn.bind(on_press=self.goto_calculatorAmbasade)
        self.add_widget(btn)
        btn = Button(text='Mixte', font_size=120, background_color=(139, 139, 0), color=(0, 0, 0, 1))
        btn.bind(on_press=self.goto_calculatorMixte)
        self.add_widget(btn)
        btn = Button(text='A.o.p/Coop', font_size=120, background_color=(139, 139, 0), color=(0, 0, 0, 1))
        btn.bind(on_press=self.goto_calculatorAop)
        self.add_widget(btn)
        btn = Button(text='Obiective A.T.', font_size=120, background_color=(0, 0, 1, 1))
        btn.bind(on_press=self.goto_calculatorObiective)
        self.add_widget(btn)
        btn = Button(text='M.o.p.', font_size=120, background_color=(255, 0, 0))
...
class CalculatorNitro(GridLayout, MainMenuButton):
    def __init__(self, **kwargs):
        ...
        self.cols = 2
        self.add_widget(MyLabelBlue(text='Kilometri plecare:', font_size=100))
        self.kilometri_plecare = TextInput(multiline=False, font_size=100, input_type='number')
        self.add_widget(self.kilometri_plecare)
        self.add_widget(MyLabelBlue(text='Kilometri sosire:', font_size=100))
        self.kilometri_sosire = TextInput(multiline=False, font_size=100, input_type='number')
        self.add_widget(self.kilometri_sosire)
        self.add_widget(Label(text='Total kilometri:', font_size=100))
        self.result = Label(text='', font_size=100)
        self.add_widget(self.result)
        self.add_widget(Label(text='București:', font_size=100))
        self.kilometri_bucuresti = Label(text='', font_size=100)
        self.add_widget(self.kilometri_bucuresti)
        self.add_widget(Label(text='Alte localități:', font_size=100))
        self.kilometri_alte_localitati = Label(text='', font_size=100)
        self.add_widget(self.kilometri_alte_localitati)
        self.add_widget(Label(text='Drumuri neamenajate:', font_size=100))
        self.drumuri_neamenajate = Label(text='', font_size=100)
        self.add_widget(self.drumuri_neamenajate)
        self.add_widget(Label(text='Patrulare:', font_size=100))
        self.patrulare = Label(text='', font_size=100)
        self.add_widget(self.patrulare)
        self.subtract = Button(text='Calculează', font_size=100, background_color=(0, 1, 0, 1))
        self.subtract.bind(on_press=self.calculate)
        self.add_widget(self.subtract)
        self.gotoMenu = Button(text='Meniu', font_size=100)
...
class CalculatorAsigurare(GridLayout, MainMenuButton):
    ...
    def __init__(self, **kwargs):
        ...
        for option in options:
            btn = Button(text=option, size_hint_y=None, height=120, font_size=100, background_color=(1, 1, 0, 1))
            btn.bind(on_release=lambda buton: self.dropdown.select(buton.text))
            self.dropdown.add_widget(btn)

        # create a button to trigger the dropdown
        self.dropdown_btn = Button(text='Selecteaza zona', size_hint_y=None, size=(80, 100), font_size=100, background_color=(0, 1, 1, 1))
        ...
        # create a button to trigger the dropdown
        self.dropdown2_btn = Button(text=' Tip patrulă', size_hint_y=None, size=(80, 100), font_size=100, background_color=(0, 1, 1, 1))
...
class CalculatorObiective(GridLayout, MainMenuButton):
    ...
    def __init__(self, **kwargs):
        ...
        # create a button to trigger the dropdown
        self.dropdown_btn = Button(text=' Obiective:', size_hint_y=None, size=(80, 100), font_size=100, background_color=(0, 1, 1, 1))
        self.dropdown_btn.bind(on_release=self.dropdown.open)
        self.dropdown.bind(on_select=lambda instance, x: setattr(self.dropdown_btn, 'text', x))
...
class CalculatorMentinere(GridLayout, MainMenuButton):
    ...
    def __init__(self, **kwargs):
        ...
        # create a button to trigger the dropdown
        self.dropdown_btn = Button(text='Selectează zona', size_hint_y=None, size=(80, 100), font_size=100, background_color=(0, 1, 1, 1))
        self.dropdown_btn.bind(on_release=self.dropdown.open)
        self.dropdown.bind(on_select=lambda instance, x: setattr(self.dropdown_btn, 'text', x))
